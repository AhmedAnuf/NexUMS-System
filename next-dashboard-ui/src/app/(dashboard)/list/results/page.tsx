...
const AssignmentListPage = () => {
  const renderRow = (item: Result) => (
    ...
    >
      ...
      <td>{item.student}</td>
      <td className="hidden md:table-cell py-4">{item.score}</td>
      <td className="hidden md:table-cell py-4 ">{item.lecturer}</td>
      <td className="hidden md:table-cell py-4">{item.class}</td>
      <td className="hidden md:table-cell py-4">{item.date}</td>
      <td>
