...
const LecturerListPage = async ({
  ...
  const renderRow = (item: LecturerList) => (
    <tr
      key={item.id}
      className="border-b border-gray-200 even:bg-slate-50 text-sm hover:bg-nexLightPurple"
    >
      ...
      <td>
        <div className="flex items-center gap-2">
          ...
          {role === "admin" && (
            // <button className="w-7 h-7 flex items-center justify-center rounded-full bg-nexPurple">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex flex-col md:flex-row items-center gap-4 w-full md:w-auto">
          ...
          <div className="flex items-center gap-4 self-end">
            <button className="w-8 h-8 flex items-center justify-center rounded-full bg-nexYellow">
