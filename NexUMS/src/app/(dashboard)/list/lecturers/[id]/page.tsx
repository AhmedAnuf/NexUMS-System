...
import BigCalenderContainer from "@/components/BigCalendarContainer";
    ...
    <div className="flex-1 p-4 flex flex-col gap-4 xl:flex-row">
      ...
      <div className="w-full xl:w-2/3">
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          {/* USER INFO CARD */}
          <div className="bg-nexSky py-6 px-4 rounded-md flex-1 flex gap-4">
            <div className="w-1/3">
              <Image
        ...
        {/* BOTTOM */}
        <div className="mt-4 bg-white rounded-md p-4 h-[650px]">
          <h1>Lecturer&apos;s Schedule</h1>
          <BigCalenderContainer type="lecturerId" id={lecturer.id} />
        </div>
      </div>
      {/* RIGHT */}
