...
//?Subject Create, Update, Delete actions
...
//?Class Create, Update, Delete actions
...
//?Lecturer Create, Update, Delete actions
...
export const updateLecturer = async (
  ...
  try {
    ...
    console.log(err);
    console.log("Updating Clerk user ID:", data.id);
...
export const deleteLecturer = async (
  ...
  try {
    const clerk = await clerkClient();
    const user = clerk.users.deleteUser(id);

    // const clerk = await clerkClient();
    // const user = await clerk.users.deleteUser;
...
//?Student Create, Update, Delete actions
...
//?Exam Create, Update, Delete actions
